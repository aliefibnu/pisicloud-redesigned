...
describe('StrategyImplementation', () => {
  ...
  it('should render child sections including hero, offerings, benefits, and universal faq', () => {
    ...
    expect(compiled.querySelector('strategy-hero')).toBeTruthy();
    expect(compiled.querySelector('strategy-offerings')).toBeTruthy();
    expect(compiled.querySelector('strategy-benefits')).toBeTruthy();
